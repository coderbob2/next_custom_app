...
3. Verify Material Request is included in the flow steps

---

## Usage Guide

### Creating Material Request with Custom Features

#### 1. Create Initial Material Request
```
1. Go to Material Request → New
...
Open any existing Material Request:
...
1. Open submitted Material Request
2. Click "Create" dropdown
3. Select "Purchase Requisition" (or next type)

**Option B: Using Custom Button**
1. Open submitted Material Request
2. Click "Create" dropdown
3. Select "Custom: Purchase Requisition"
...
```
F12 → Console tab
Look for: "=== Material Request Custom Script Initializing ==="
```
...
**Possible Causes**:
1. **No documents created yet**: Create a Purchase Requisition from the Material Request
...
- Initial implementation of custom tab section
